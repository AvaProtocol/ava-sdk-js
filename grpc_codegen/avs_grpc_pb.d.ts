...
interface IAggregatorService_IGetKey
  extends grpc.MethodDefinition<avs_pb.GetKeyReq, avs_pb.KeyResp> {
...
interface IAggregatorService_IGetNonce
  extends grpc.MethodDefinition<avs_pb.NonceRequest, avs_pb.NonceResp> {
...
interface IAggregatorService_IGetSmartAccountAddress
  extends grpc.MethodDefinition<avs_pb.AddressRequest, avs_pb.AddressResp> {
...
interface IAggregatorService_ICreateTask
  extends grpc.MethodDefinition<avs_pb.CreateTaskReq, avs_pb.CreateTaskResp> {
...
interface IAggregatorService_IListTasks
  extends grpc.MethodDefinition<avs_pb.ListTasksReq, avs_pb.ListTasksResp> {
...
interface IAggregatorService_IGetTask
  extends grpc.MethodDefinition<avs_pb.UUID, avs_pb.Task> {
...
interface IAggregatorService_ICancelTask
...
interface IAggregatorService_IDeleteTask
  extends grpc.MethodDefinition<
    avs_pb.UUID,
    google_protobuf_wrappers_pb.BoolValue
  > {
...
interface IAggregatorService_IPing
  extends grpc.MethodDefinition<avs_pb.Checkin, avs_pb.CheckinResp> {
...
interface IAggregatorService_ISyncTasks
  extends grpc.MethodDefinition<avs_pb.SyncTasksReq, avs_pb.SyncTasksResp> {
...
interface IAggregatorService_IUpdateChecks
  extends grpc.MethodDefinition<
    avs_pb.UpdateChecksReq,
    avs_pb.UpdateChecksResp
  > {
...
export interface IAggregatorServer extends grpc.UntypedServiceImplementation {
  ...
  getSmartAccountAddress: grpc.handleUnaryCall<
  ...
  cancelTask: grpc.handleUnaryCall<
    ...
    google_protobuf_wrappers_pb.BoolValue
  >;
  deleteTask: grpc.handleUnaryCall<
    avs_pb.UUID,
    google_protobuf_wrappers_pb.BoolValue
  >;
  ping: grpc.handleUnaryCall<avs_pb.Checkin, avs_pb.CheckinResp>;
  syncTasks: grpc.handleServerStreamingCall<
    avs_pb.SyncTasksReq,
    avs_pb.SyncTasksResp
  >;
  updateChecks: grpc.handleUnaryCall<
    avs_pb.UpdateChecksReq,
    avs_pb.UpdateChecksResp
  >;
}
...
export interface IAggregatorClient {
  getKey(
    request: avs_pb.GetKeyReq,
    callback: (
      error: grpc.ServiceError | null,
      response: avs_pb.KeyResp
    ) => void
  ...
  getNonce(
    request: avs_pb.NonceRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: avs_pb.NonceResp
    ) => void
  ): grpc.ClientUnaryCall;
  getNonce(
    request: avs_pb.NonceRequest,
  ...
  getSmartAccountAddress(
    request: avs_pb.AddressRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: avs_pb.AddressResp
    ) => void
  ): grpc.ClientUnaryCall;
  getSmartAccountAddress(
    request: avs_pb.AddressRequest,
  ...
  createTask(
    request: avs_pb.CreateTaskReq,
    callback: (
      error: grpc.ServiceError | null,
      response: avs_pb.CreateTaskResp
    ) => void
  ): grpc.ClientUnaryCall;
  createTask(
    request: avs_pb.CreateTaskReq,
  ...
  listTasks(
    request: avs_pb.ListTasksReq,
    callback: (
      error: grpc.ServiceError | null,
      response: avs_pb.ListTasksResp
    ) => void
  ): grpc.ClientUnaryCall;
  listTasks(
    request: avs_pb.ListTasksReq,
  ...
  getTask(
    request: avs_pb.UUID,
    callback: (error: grpc.ServiceError | null, response: avs_pb.Task) => void
  ): grpc.ClientUnaryCall;
  getTask(
    request: avs_pb.UUID,
    metadata: grpc.Metadata,
  ...
  ping(
    request: avs_pb.Checkin,
    callback: (
      error: grpc.ServiceError | null,
      response: avs_pb.CheckinResp
    ) => void
  ): grpc.ClientUnaryCall;
  ping(
    request: avs_pb.Checkin,
  ...
  syncTasks(
    request: avs_pb.SyncTasksReq,
    options?: Partial<grpc.CallOptions>
  ): grpc.ClientReadableStream<avs_pb.SyncTasksResp>;
  syncTasks(
    request: avs_pb.SyncTasksReq,
    metadata?: grpc.Metadata,
    options?: Partial<grpc.CallOptions>
  ...
  updateChecks(
    request: avs_pb.UpdateChecksReq,
    callback: (
      error: grpc.ServiceError | null,
      response: avs_pb.UpdateChecksResp
    ) => void
  ): grpc.ClientUnaryCall;
  updateChecks(
    request: avs_pb.UpdateChecksReq,
