...
# Usage:
#   ./scripts/get-gh-job.sh <JOB_ID>
#   ./scripts/get-gh-job.sh --job-id <JOB_ID>
#   ./scripts/get-gh-job.sh --run-id <RUN_ID> [--job-name <JOB_NAME>]
...
while [[ $# -gt 0 ]]; do
  case $1 in
    ...
    -h|--help)
      ...
      echo "  --repo <REPO>     Repository (default: AvaProtocol/ava-sdk-js)"
